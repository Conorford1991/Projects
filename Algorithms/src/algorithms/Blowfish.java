...
public class Blowfish {
    ...
    public Blowfish() throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException{
    ...
    public byte[] Encrypt(String Plaintext) throws BadPaddingException, IllegalBlockSizeException{
        ...
        System.out.println("Blowfish Ciphertext: "+Ciphertext);
    ...
    public void Decrypt(byte[] byteCiphertext) throws IllegalBlockSizeException, BadPaddingException{
        ...
        System.out.println("Blowfish Plaintext after decryption: "+Plaintext);
    }
}
