...
public class DES {
     ...
     // DES constructor
     public DES() throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException{
        // Instantiation of a DES key generator
        KeyGenerator key = KeyGenerator.getInstance("DES");
        
        // Instantiation of a secretkey
        // Generate a DES secret key using the key generator. 
        SecretKey secretkey = key.generateKey();
        
        // Generate encryption cipher (DES, Cipher Feedback Block, Public-Key Cryptography Standards-5 Padding )
        encipher = Cipher.getInstance("DES/CFB/PKCS5Padding");
        
        // Generate decryption cipher (DES, Cipher Feedback Block, Public-Key Cryptography Standards-5 Padding )
        decipher = Cipher.getInstance("DES/CFB/PKCS5Padding");
    ...
    public byte[] Encrypt(String Plaintext) throws BadPaddingException, IllegalBlockSizeException, FileNotFoundException, UnsupportedEncodingException{
        ...
        fl.EncryptedFileWriter(Ciphertext,"DES");
        
         // Print
        System.out.println("DES encryption complete. Ciphertext write to file sucessful");
    ...
    public void Decrypt(byte[] byteCiphertext) throws IllegalBlockSizeException, BadPaddingException, FileNotFoundException{
        ...
        fl.DecryptedFileWriter(Plaintext,"DES");
        
         // Print
        System.out.println("DES decryption complete. Plaintext write to file sucessful");
    }
}
