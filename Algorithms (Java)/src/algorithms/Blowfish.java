...
public class Blowfish{
     ...
     public Blowfish() throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException{
        // Instantiation of a Blowfish key generator
        KeyGenerator key = KeyGenerator.getInstance("Blowfish");
        
        // Instantiation of a secretkey
        // Generate a Blowfish secret key using the key generator. 
        SecretKey secretkey = key.generateKey();
        
        // Generate encryption cipher (Blowfish, Cipher Feedback Block, Public-Key Cryptography Standards-5 Padding )
        encipher = Cipher.getInstance("Blowfish/CFB/PKCS5Padding");
        
        // Generate decryption cipher (Blowfish, Cipher Feedback Block, Public-Key Cryptography Standards-5 Padding )
        decipher = Cipher.getInstance("Blowfish/CFB/PKCS5Padding");
    ...
    public byte[] Encrypt(String Plaintext) throws BadPaddingException, IllegalBlockSizeException, FileNotFoundException, UnsupportedEncodingException{
        ...
        fl.EncryptedFileWriter(Ciphertext,"Blowfish");
        
         // Print
        System.out.println("Blowfish encryption complete. Ciphertext write to file sucessful");
    ...
    public void Decrypt(byte[] byteCiphertext) throws IllegalBlockSizeException, BadPaddingException, FileNotFoundException{
        ...
        fl.DecryptedFileWriter(Plaintext,"Blowfish");
        
         // Print
        System.out.println("Blowfish decryption complete. Plaintext write to file sucessful");
    }
}
